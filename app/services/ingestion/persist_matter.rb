    ...
    def self.attributes_from(matter_payload, fetched_at:, response_sha256:, snapshot:)
      {
        ...
        intro_date: Coerce.date(matter_payload["MatterIntroDate"], field: "MatterIntroDate"),
        agenda_date: Coerce.date(matter_payload["MatterAgendaDate"], field: "MatterAgendaDate"),
        passed_date: Coerce.date(matter_payload["MatterPassedDate"], field: "MatterPassedDate"),
        enactment_date: Coerce.date(matter_payload["MatterEnactmentDate"], field: "MatterEnactmentDate"),
        ...
        source_last_modified_at: Coerce.datetime(matter_payload["MatterLastModifiedUtc"], field: "MatterLastModifiedUtc"),
