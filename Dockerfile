...
# docker build -t san_jose_civic_gallery .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name san_jose_civic_gallery san_jose_civic_gallery
